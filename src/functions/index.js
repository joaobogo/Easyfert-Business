...
export const translate = (word) => {
    const english = { pending: 'Pendente', approved: 'Aprovado', cancelled:'Cancelado' }
...
export const saveToCart = (newcart) => { localStorage.setItem('newcart', JSON.stringify(newcart))} 
